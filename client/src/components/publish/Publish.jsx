...
export default function Publish() {
  ...
  const [image, setImage] = useState(null); // Image present or not
  ...
  const handleClick = async (e) => {
    ...
    mutation.mutate({ text: text.trim(), img: newImage });

    // Reset states
    setImage(""); // Make sure URL generated by URL.createObjectURL is no longer used
